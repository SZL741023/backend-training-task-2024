...
var l = "8";
// 請文字解釋為什麼
console.log(k * l > 21); // true 數字與字串相乘，會轉型成number後再做運算，所以k * l = 24, 24 > 21, 所以是true.
...
const gymCoach = {
  coachs: [
    {
      name: "Coach Wang",
      Expertise: "Strength training, weight loss courses",
      courses: [
        {
          courseName: "personalTrainingCourse",
          price: 2000,
          courseTime: 60,
          available: true,
        },
        {
          courseName: "groupTrainingCourse",
          price: 1500,
          courseTime: 90,
          available: false,
        },
      ...
      background:
        "Wang coach has 5 years of teaching experience and specializes in improving students' muscle strength and fat loss. He is suitable for students who want to achieve their physical fitness goals quickly.",
    ...
    },
    {
      ...
      background:
        "Coach Lee is a yoga master with 10 years of teaching experience. He is good at helping students sculpt their perfect bodies and is suitable for students who want to improve their posture and flexibility.",
...
for (let i = 0; i < performanceData.coaches.length; i++) {
  if (performanceData["coaches"][i]["name"] === "Alice") {
    performanceData["coaches"][i]["performance"] += 8000;
  } else if (performanceData["coaches"][i]["name"] === "Bob") {
    performanceData["coaches"][i]["performance"] += 12000;
  }
}
...
let calorieBurn = 0;
calorieBurn =
  20 * activities["calorieBurnPerMin"]["bicycle"] +
  30 * activities["calorieBurnPerMin"]["running"] +
  40 * activities["calorieBurnPerMin"]["yoga"];
